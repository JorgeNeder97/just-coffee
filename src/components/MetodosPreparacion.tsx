        ...
        <div className="flex flex-col place-items-center place-content-center gap-[70px] sm:gap-[100px] px-[30px] sm:px-[50px] lg:px-[30px] py-[50px] sm:py-[100px]">
            ...
            <div className="flex flex-col place-items-center place-content-center gap-[100px] sm:gap-[150px] lg:gap-[100px]">
                ...
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    ...
                    <Image width={650} height={650} src="/MfrenchPress.webp" className="rightSide lg:order-2 lg:w-[550px] rounded-xl brightness-75" alt="" />
                </div>
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    <div className="methodTextContent rightSide lg:order-2 lg:w-[550px] sm:leading-[30px]">
                    ...
                    <Image width={650} height={650} src="/MaeroPress.webp" className="leftSide lg:order-1 lg:w-[550px] rounded-xl brightness-75" alt="" />
                </div>
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    <div className="methodTextContent leftSide lg:order-1 lg:w-[550px] sm:leading-[30px]">
                    ...
                    <Image width={650} height={650} src="/McoldBrew.webp" className="rightSide lg:order-2 lg:w-[550px] rounded-xl brightness-75" alt="" />
                </div>
            </div>
        </div>
    );
