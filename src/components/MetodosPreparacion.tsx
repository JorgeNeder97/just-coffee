        ...
        <div className="flex flex-col place-items-center place-content-center gap-[70px] sm:gap-[100px] px-[30px] sm:px-[50px] lg:px-[30px] py-[50px] sm:py-[100px]">
            ...
            <div className="flex flex-col place-items-center place-content-center gap-[100px] sm:gap-[150px] lg:gap-[100px]">
                ...
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    ...
                    <Image width={550} height={367} unselectable="on" style={{ userSelect: "none" }} src="/Mespresso.webp" className="fromRight order-2 lg:order-2 lg:w-[550px] rounded-xl brightness-75" alt="Café Espresso" />
                ...
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    ...
                    <Image width={550} height={367} unselectable="on" style={{ userSelect: "none" }} src="/Mgoteo.png" className="fromLeft order-2 lg:order-1 lg:w-[550px] rounded-xl brightness-75" alt="Café de Goteo" />
                ...
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    ...
                    <Image width={550} height={367} unselectable="on" style={{ userSelect: "none" }} src="/MfrenchPress.webp" className="fromRight order-2 lg:order-2 lg:w-[550px] rounded-xl brightness-75" alt="" />
                ...
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    ...
                    <Image width={550} height={367} unselectable="on" style={{ userSelect: "none" }} src="/MaeroPress.webp" className="fromLeft order-2 lg:order-1 lg:w-[550px] rounded-xl brightness-75" alt="" />
                ...
                <div className="methodContent lg:flex-row lg:place-items-start lg:gap-[50px]">
                    ...
                    <Image width={550} height={367} unselectable="on" style={{ userSelect: "none" }} src="/McoldBrew.webp" className="fromRight order-2 lg:order-2 lg:w-[550px] rounded-xl brightness-75" alt="" />
