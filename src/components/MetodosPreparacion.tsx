        ...
        <div className="flex flex-col place-items-center place-content-center lg:gap-[100px] lg:py-[100px]">
            ...
            <div className="flex flex-col place-items-center place-content-center lg:gap-[100px]">
                <div className="methodContent">
                    <div className="methodTextContent order-1 lg:w-[550px] lg:leading-[30px]">
                    ...
                    <img src="/Mespresso.jpg" className="order-2 lg:w-[550px] rounded-xl brightness-75" alt="Café Espresso" />
                </div>
                <div className="methodContent">
                    <div className="methodTextContent order-2 lg:w-[550px] lg:leading-[30px]">
                    ...
                    <img src="/Mgoteo.png" className="order-1 lg:w-[550px] rounded-xl brightness-75" alt="Café de Goteo" />
                </div>
                <div className="methodContent">
                    <div className="methodTextContent order-1 lg:w-[550px] lg:leading-[30px]">
                    ...
                    <img src="/MfrenchPress.webp" className="order-2 lg:w-[550px] rounded-xl brightness-75" alt="" />
                </div>
                <div className="methodContent">
                    <div className="methodTextContent order-2 lg:w-[550px] lg:leading-[30px]">
                    ...
                    <img src="/MaeroPress.webp" className="order-1 lg:w-[550px] rounded-xl brightness-75" alt="" />
                </div>
                <div className="methodContent">
                    <div className="methodTextContent order-1 lg:w-[550px] lg:leading-[30px]">
                    ...
                    <img src="/McoldBrew.webp" className="order-2 lg:w-[550px] rounded-xl brightness-75" alt="" />
                </div>
            </div>
        </div>
    );
