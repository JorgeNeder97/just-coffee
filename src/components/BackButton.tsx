    ...
    return (
        <Link href={href} className="absolute top-[15px] lg:top-[30px] right-[10px] lg:right-[70px] z-40 text-white hover:cursor-pointer group">
            <div className="flex place-items-center place-content-between overflow-hidden w-[110px] lg:w-[140px]">
                ...
                <Image width={100} height={100} unselectable="on" style={{ userSelect: "none" }} src="/coffeeFavicon.png" className="lg:translate-x-[5px] w-[30px] lg:w-[50px] lg:brightness-75 lg:group-hover:animate-frontSpin group-active:animate-frontSpin animate-backSpin" alt="Volver atrás" />
            </div>
        </Link>
    )
};
